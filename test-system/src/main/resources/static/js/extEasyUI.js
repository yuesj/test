 ...
 * 
 */
sy.createWindow = function(id, options) {
	var opts = $.extend({
		title : '&nbsp;',
		width : 640,
		loadingMessage : '数据加载中。。。',
	...
	return $('<div id="' + id + '"></div>').window(opts);
};

sy.createFlash = function(name, url, div, width, height, flashvar) {
	...
	swfobject.embedSWF(url, div, width, height, swfVersionStr, xiSwfUrlStr, flashvars, params, attributes);
	swfobject.createCSS("#" + div, "position:absolute;left:0px;top:0px;reldisplay:block;text-align:left;");
};
